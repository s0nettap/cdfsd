...
surface_data_t* game_trace_t::get_surface_data_t( ) {
	...
	static fn_get_surface_data_t o_get_surface_data = reinterpret_cast<fn_get_surface_data_t>( g_opcodes->scan_absolute( g_modules->m_modules.client_dll.get_name( ), "E8 ? ? ? ? 48 85 C0 74 ? 44 38 68", 0x1 ) );
